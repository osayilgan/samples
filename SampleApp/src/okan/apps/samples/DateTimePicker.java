...
public class DateTimePicker implements OnClickListener {
	...
	public View getDateTimePickerLayout() {
		...
		FrameLayout.LayoutParams frame_match_wrap = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.FILL_PARENT,
				FrameLayout.LayoutParams.WRAP_CONTENT);

		LinearLayout.LayoutParams button_params = new LinearLayout.LayoutParams(0,
	...
	public void onClick(View v) {
		...
		case SET:
			...
			if (iCustomDateTimeListener != null) {
				...
				iCustomDateTimeListener.onSet(calendar_date, calendar_date.getTime(), calendar_date.get(Calendar.YEAR),
						getMonthFullName(calendar_date.get(Calendar.MONTH)),
						getMonthShortName(calendar_date.get(Calendar.MONTH)), calendar_date.get(Calendar.MONTH),
						...
						getHourIn12Format(calendar_date.get(Calendar.HOUR_OF_DAY)), calendar_date.get(Calendar.MINUTE),
						calendar_date.get(Calendar.SECOND), getAMPM(calendar_date));
			}
			resetData();
			break;
	 ...
	 *            date in String
	 * @param fromFormat
	 *            format of your <b>date</b> eg: if your date is 2011-07-07 09:09:09 then your format will be
	 *            <b>yyyy-MM-dd hh:mm:ss</b>
	 * @param toFormat
	 *            format to which you want to convert your <b>date</b> eg: if required format is 31 July 2011 then the
	 *            toFormat should be <b>d MMMM yyyy</b>
	...
	/**
	 * @param weekDayNumber
	 *            Week Number starts with 1. For <b>Sunday</b> it is <b>1</b> and for <b>Saturday</b> it is <b>7</b>.
	 * @return
	 */
	...
	private int getHourIn12Format(int hour24) {
		...
		if (hour24 == 0) hourIn12Format = 12;
		else if (hour24 <= 12) hourIn12Format = hour24;
		else hourIn12Format = hour24 - 12;
